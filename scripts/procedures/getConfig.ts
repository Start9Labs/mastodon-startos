            ...
            "variants": {
              "true": {
                "openssl-verify-mode": {
                  ...
                  "description": "When using TLS, you can set how OpenSSL checks the certificate. This is really useful if you need to validate a self-signed and/or a wildcard certificate",
                  "values": [
                    "none",
                    "peer",
                  ],
